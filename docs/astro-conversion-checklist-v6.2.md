# Astro Migration Checklist — v6.2 (ICJIA Infonet post-cutover snapshot, 2026-05-27)

> **Checklist version: v6.2 (canonical / current). Continuously updated.**
>
> File renamed from `astro-conversion-checklist-v6.2.md` → `astro-conversion-checklist-v6.2.md` on 2026-05-27 to signal the Infonet post-cutover increment (Tailwind utility grids, inlineStylesheets trade-off, YouTube facade, MDC sentinel placeholders, Strapi v3 base64 splash pipeline, label-content-name-mismatch sweep) plus the new "Flagship guidance" section for icjia.illinois.gov. **The v6.0 ancestor (IFVCC era) lives in git history at `7493e3f^:docs/astro-conversion-checklist-v6.2.md`.**
>
...
| **Checklist version bookkeeping** | "Companion docs (current as of v5.0.0)" — versioning by checklist file revision. | **Bump the version inline AND in the filename** (`docs/astro-conversion-checklist-v6.2.md`) when a phase's lessons accumulate beyond a row-or-two delta. v6 was earned through the post-cutover lesson set above; rename gives commit history a clear "this is the v6 era" anchor. Cross-reference updates needed in: root `README.md`, `CHANGELOG.md`, `docs/llm-migration-prompt.md`, `docs/superpowers/plans/*.md`, `docs/superpowers/specs/*.md`. |
...
- `docs/astro-conversion-checklist-v6.2.md` — this file. The canonical checklist. **Use for any new ICJIA migration (next: infonet).**
