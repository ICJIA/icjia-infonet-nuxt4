/**
 * Markdown News Generator
 * Fetches news articles from Strapi API and generates markdown files
 * Creates news content with metadata and search indexing
 * @module creators/createMarkdownNews
 * @requires dotenv
 * @requires fs
 * @requires path
 * @requires axios
